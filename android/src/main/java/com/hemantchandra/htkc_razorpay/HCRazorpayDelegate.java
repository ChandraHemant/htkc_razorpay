package android.src.main.java.com.hemantchandra.htkc_razorpay;
...
public class HCRazorpayDelegate implements ActivityResultListener, ExternalWalletListener, PaymentResultWithDataListener {
    ...
    public HCRazorpayDelegate(Activity activity) {
