...
import 'package:htkc_razorpay/upi_turbo.dart';

class HCRazorpay {
  // Response codes from platform
  static const codePaymentSuccess = 0;
  static const codePaymentError = 1;
  static const codePaymentExternalWallet = 2;
  ...
  void _handleResult(Map<dynamic, dynamic> response) {
    ...
    switch (response['type']) {
      ...
      case codePaymentExternalWallet:
